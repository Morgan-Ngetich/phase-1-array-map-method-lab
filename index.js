...
//   const splitTutorials = sentence.split(' ') // spliting the array into single words
 
//      return splitTutorials.map ((words) => words.charAt(0).toUpperCase() + words.slice(1).toLowerCase()).join(' ');
// });
// }
